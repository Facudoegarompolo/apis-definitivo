...
public class ControllerProducto {
    ...
    public List<ProductoResponse> getProductosByMarcaId(@PathVariable Long marcaId) {
        return productoService.getProductosByMarcaId(marcaId);
    }

    @GetMapping("/ofertas")
    public List<ProductoResponse> getProductosEnOferta() {
        return productoService.getProductosEnOferta();
    }
