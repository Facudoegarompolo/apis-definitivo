...
public class CarritoService {
    ...
    public CarritoResponse getCarrito(String email) {
        Usuario usuario = getUsuario(email);
        Carrito carrito = obtenerOCrearCarrito(usuario.getId());
        return toResponse(carrito);
    }

    public CarritoResponse agregarItem(String email, CartItemRequest request) {
        ...
        CarritoItem item = carritoItemRepository
                .findByCarritoAndProducto_Id(carrito, producto.getId())
                .orElseGet(() -> {
    ...
    public CarritoResponse actualizarCantidad(String email,
                                          Long productoId,
        ...
        CarritoItem item = carritoItemRepository
                .findByCarritoAndProducto_Id(carrito, productoId)
    ...
    public void vaciarCarrito(String email) {
        ...
        Usuario usuario = getUsuario(email);
        carritoRepository.findByUsuario_Id(usuario.getId())
